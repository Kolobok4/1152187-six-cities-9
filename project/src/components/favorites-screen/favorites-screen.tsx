...
function FavoritesScreen({isLoggedIn, isFavorites} : FavoritesScreenProps): JSX.Element {
  return (
    <div className={`page ${!isLoggedIn &&  'page--favorites-empty'}`}>
      <Header isLoggedIn={isLoggedIn} />
      <main className={`page__main page__main--favorites ${!isLoggedIn && 'page__main--favorites-empty'}`}>
        <div className="page__favorites-container container">
          <section className={`favorites ${!isLoggedIn && 'favorites--empty'}`}>
            {isFavorites ? (
              <Fragment>
